...
| `fixtures/tools/lifecycle.json`, `verify-lifecycle.go` | 77 pinned SDK comparisons of results and resulting filesystem trees for Write, Edit, Move and Delete, including Edit diff rendering and both write-access variants. |
